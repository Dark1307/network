...
**Network mapper & port scanner** — a student project (6th semester) implemented in **Python** that wraps `nmap` to discover hosts, enumerate open ports/services, and produce JSON/HTML reports. A minimal **Flask** web UI allows local demo and report browsing.
